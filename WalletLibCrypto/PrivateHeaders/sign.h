...
void scalar_add_no_overflow(const ed25519_secret_key sk1,
                            const ed25519_secret_key sk2,
                            ed25519_secret_key res) {
...
static void add_left(ed25519_secret_key res_key,
                     uint8_t *z,
...
static void add_right(ed25519_secret_key res_key,
                      uint8_t *z,
                      ed25519_secret_key priv_key,
                      derivation_scheme_mode mode) {
    switch (mode) {
